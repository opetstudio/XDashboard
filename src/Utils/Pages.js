...
const lp = {
  '/home': { route: '/home', path: '/home/:sessionToken', component: PageHome, role: '100,200,210,300,310,400' }, // 1
  '/usermanagement/listAllUser': { route: '/usermanagement/listAllUser', path: '/usermanagement/listAllUser/:sessionToken', component: PageListUser, role: '100,200,210,300,310,400', title: 'All User' }, // 2
  ...
  '/user/create': { route: '/user/create', path: '/user/create/:sessionToken', component: PageCreateUser, role: '100,200,210,300,310,400' },
  ...
  '/user/list': { route: '/user/list', path: '/user/list/:sessionToken', component: PageListUser, role: '100,200,210,300,310,400' },
  '/report': { route: '/report', path: '/report/:sessionToken', component: PagePaymentReport, role: '100,200,210,300,310,400', title: 'Payment Report' },
  ...
  '/report-transaction/list-detail-transaction': { route: '/report-transaction/list-detail-transaction', path: '/report-transaction/list-detail-transaction/:sessionToken', component: PagePaymentReport, role: '100,200,210,300,310,400', title: 'Transaction Report' },
  ...
  // '/': {route: '/', path: '/:sessionToken', component: PageHome, role: '100,200,210,300,310,400'} // 0
}
