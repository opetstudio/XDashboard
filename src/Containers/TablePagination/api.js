...
export const create = api => ({
  tablepaginationFetchAllTrxForVaReport: (data, { encryptedAccessToken, url, userMerchantCode, userMerchantId }) => {
    console.log('tablepaginationFetchAllTrxForVaReport====')
    const params = {}
    ...
    const resp = api.get('/plink/virtualaccount/report', { ...params, ...setFilter(data) })
    return resp
  },
