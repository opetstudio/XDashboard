        ...
        <div className='box-body'>
          <div className='row'>
            <div className='col-md-6'>
                ...
                <div className='form-group'>
                  <label htmlFor='inputEmail3' className='col-sm-3 control-label'>Source Of Fund</label>
                  <div className='col-sm-9'>
                          <select className='form-control select2' style={{width: '100%'}}>
              ...
              <form className='form-horizontal'>
                  ...
                  <div className='col-sm-9'>
                    <select className='form-control select2' style={{width: '100%'}}>
                      ...
                      <option>2.000.001 - 2.500.000</option>
                      <option>2.500.001 - 10.000.000</option>
                      <option>10.000.001 - 100.000.000</option>
                      <option>lebih dari 100.000.001</option>
                    </select>
                  </div>
                </div>
                      {/* <div className='form-group'>
