...
class SidebarInstitutionAdmin extends Component {
  render () {
    console.log('render')
      ...
      <ul className='sidebar-menu' data-widget='tree'>
        ...
        <li className='active treeview menu-open'>
          ...
          <ul className='treeview-menu'>
            ...
            {this.props.getMenuLi('/merchant/all', 'Merchant')}
        ...
        <li className='active treeview menu-open'>
          <Link to='#'>
            <i className='fa fa-briefcase text-green' /> <span>QR Code</span>
            <span className='pull-right-container'>
              <i className='fa fa-angle-left pull-right' />
            </span>
          </Link>
          <ul className='treeview-menu'>
            {this.props.getMenuLi('/institution/qrcode/allactive', 'All Active')}
          </ul>
        </li>
        {/* <li className='active treeview menu-open'>
          <Link to='#'>
