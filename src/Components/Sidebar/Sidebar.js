    ...
    return (
      <aside className='main-sidebar'>
        <section className='sidebar'>
          {(this.props.userRole >= 400 && this.props.userRole < 500) && <SidebarOperator
          ...
          />}
          {(this.props.userRole >= 310 && this.props.userRole < 400) && <SidebarOperator
            getMenuLiSingle={this._getMenuLiSingle}
            getMenuLi={this._getMenuLi}
            appPatch={this.props.appPatch}
            sessionToken={this.props.sessionToken}
            routeActive={this.props.routeActive}
          />}
          {(this.props.userRole >= 300 && this.props.userRole < 310) && <SidebarOperator
            getMenuLiSingle={this._getMenuLiSingle}
            getMenuLi={this._getMenuLi}
            appPatch={this.props.appPatch}
            sessionToken={this.props.sessionToken}
            routeActive={this.props.routeActive}
          />}
          {(this.props.userRole >= 210 && this.props.userRole < 300) && <SidebarOperator
            getMenuLiSingle={this._getMenuLiSingle}
            getMenuLi={this._getMenuLi}
            appPatch={this.props.appPatch}
            sessionToken={this.props.sessionToken}
            routeActive={this.props.routeActive}
          />}
          {(this.props.userRole >= 200 && this.props.userRole < 210) && <SidebarInstitutionAdmin
            getMenuLiSingle={this._getMenuLiSingle}
            getMenuLi={this._getMenuLi}
            appPatch={this.props.appPatch}
            sessionToken={this.props.sessionToken}
            routeActive={this.props.routeActive}
          />}
          {(this.props.userRole >= 100 && this.props.userRole < 200) && <SidebarOperator
            getMenuLiSingle={this._getMenuLiSingle}
            getMenuLi={this._getMenuLi}
            appPatch={this.props.appPatch}
            sessionToken={this.props.sessionToken}
